...
public class BeanHelper {
	...
	private static synchronized BeanXMLMapper getMapper(Class beanClass) {
		...
		if (mapper == null) {
			InputStream in = BeanHelper.class.getResourceAsStream("/resources/"
					+ beanClass.getSimpleName() + ".map.xml");
			try {
	 ...
	 */
	public static void toBean(Class beanClass, Object bean, Element node)
			throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static void toUpdateXML(Class beanClass, Object bean,
			NodeBuilder builder) throws ParseException {
		Iterator<Class> it = new ClassIterator(beanClass);
		while (it.hasNext()) {
			Class clazz = it.next();
			BeanXMLMapper mapper = getMapper(clazz);
	 ...
	 * @throws ParseException
	 */
	public static void toFullXML(Class beanClass, Object bean,
			NodeBuilder builder) throws ParseException {
		Iterator<Class> it = new ClassIterator(beanClass);
		while (it.hasNext()) {
			Class clazz = it.next();
	...
	private static class ClassIterator implements Iterator<Class> {
		...
		public boolean hasNext() {
			return !this.clazz.getSimpleName().equals(
		...
		public void remove() {
			throw new IllegalAccessError(
					"Sorry, I couldn't break the Java law...");
		}
