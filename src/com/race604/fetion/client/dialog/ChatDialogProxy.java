...
public class ChatDialogProxy implements DialogListener
{
    ...
    /**
     * 
     * @see com.race604.fetion.client.dialog.Dialog#closeDialog()
     */
...
//        	logger.warn("Close Dialog Failed.",e);
	...
	/**
     * @return
     * @see com.race604.fetion.client.dialog.ChatDialog#getMainBuddy()
     */
	...
	/**
     * @return
     * @see com.race604.fetion.client.dialog.Dialog#getSession()
     */
	...
	/**
     * @return
     * @see com.race604.fetion.client.dialog.Dialog#getState()
     */
     ...
     * @throws DialogException
     * @see com.race604.fetion.client.dialog.Dialog#openDialog()
     */
	...
	/**
     * @param listener
     * @see com.race604.fetion.client.dialog.Dialog#openDialog(com.race604.fetion.event.action.ActionEventListener)
     */
     ...
     * @param message
     * @return
     * @see com.race604.fetion.client.dialog.ChatDialog#sendChatMessage(net.solosky.maplefetion.bean.Message)
     */
     ...
     * @param message
     * @param listener
     * @see com.race604.fetion.client.dialog.ChatDialog#sendSMSMessage(net.solosky.maplefetion.bean.Message, com.race604.fetion.event.action.ActionEventListener)
     */
     ...
     * @param message
     * @return
     * @see com.race604.fetion.client.dialog.ChatDialog#sendSMSMessage(net.solosky.maplefetion.bean.Message)
     */
