...
import com.race604.fetion.client.ParseException;
...
public class XMLHelper {
	...
	/**
	 * 以给定的路径查找列表元素 contacts/*contact 表示查找contacts下面的所有的名字为contact的节点
	...
	/**
	 * 以给定的路径查找特定的元素 contact/basic 表示查找contact下面子节点名字为basic的节点
