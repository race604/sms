...
public class HttpApplication
{
	 ...
	 * @throws IOException 
	 */
	public static long setPortrait(FetionContext context, Bitmap image) throws IOException
	{
		// TODO 修改这里，可以用来设置头像
...
//		return Long.parseLong(new String(bytes));
	 ...
	 * @throws IOException
	 */
	public static Bitmap getPortrait(FetionContext context, Buddy buddy, int size) throws IOException {
		// TODO 设置头像
...
//		return ImageIO.read(new ByteArrayInputStream(bytes));
	 ...
	 */
	public static VerifyImage fetchVerifyImage(User user, /*LocaleSetting setting, */String alg, String type) throws IOException, JDOMException
	{
		// TODO 应该从本地配置中获取，还没有实现本地设置类
